...
const ComingSoon = () => {
  ...
  return (
    <div className='coming-soon'>
      <div className='coming-soon__overlay'></div>

      <div className='coming-soon__content'>
        <div className='coming-soon__logo'>
          <h1 className='coming-soon__brand'>Nakachi Ndumdi</h1>
        ...
        <div className='coming-soon__main'>
          ...
          <div className='coming-soon__countdown'>
            <div className='countdown-item'>
              <div className='countdown-item__value'>{timeLeft.days}</div>
              <div className='countdown-item__label'>Days</div>
            </div>
            <div className='countdown-item'>
              <div className='countdown-item__value'>{timeLeft.hours}</div>
              <div className='countdown-item__label'>Hours</div>
            </div>
            <div className='countdown-item'>
              <div className='countdown-item__value'>{timeLeft.minutes}</div>
              <div className='countdown-item__label'>Minutes</div>
            </div>
            <div className='countdown-item'>
              <div className='countdown-item__value'>{timeLeft.seconds}</div>
              <div className='countdown-item__label'>Seconds</div>
            </div>
          </div>

          <div className='coming-soon__notify'>
            <h3 className='notify__title'>Get Notified When We Launch</h3>
            <div className='notify__form'>
              <input
                type='email'
              ...
              />
              <button onClick={handleSubmit} className='notify__button'>
                Notify Me
              </button>
            </div>
          </div>
      ...
      <div className='coming-soon__particles'>
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className='particle'
